...
Данный проект создан на основе материалов пройденного ранее курса "LearnQA - Автоматизация мобильных приложений". 
 В процессе разработки проект был полностью переписан с использования Selenium WebDriver на Selenide, а также дополнен новыми автотестами, применён JUnit 5, обновлена структура проекта и стек технологий.
